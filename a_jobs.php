    ...
    <div class="container">
      ...
      <div class="course" style="margin-top: -50px;">
        ...
        <div class="info">
          ...
          <a href="action1.php"><button class="btn">more information</button></a>
        </div>
      </div>
      ...
      <div class="course" style="margin-top: 150px;">
        <div class="preview">
          ...
          <?php
                if($conn_link= mysqli_connect('localhost' , 'root')){
                mysqli_select_db($conn_link ,'job');               
                if($result = mysqli_query($conn_link ,"SELECT Organization FROM jobs WHERE Id =2")){
                 while($rows=mysqli_fetch_assoc($result)){
                echo '' .$rows['Organization'];
                 }
                 }else{
        ...
        <div class="info">
          ...
          <a href="action2.php"><button class="btn">more information</button></a>
        </div>
      </div>
      ...
      <div class="course" style="margin-top: 350px;">
        <div class="preview">
          ...
          <?php
                if($conn_link= mysqli_connect('localhost' , 'root')){
                mysqli_select_db($conn_link ,'job');               
                if($result = mysqli_query($conn_link ,"SELECT Organization FROM jobs WHERE Id =3")){
                 while($rows=mysqli_fetch_assoc($result)){
                echo '' .$rows['Organization'];
                 }
                 }else{
        ...
        <div class="info">
          ...
          <a href="action3.php"><button class="btn">more information</button></a>
        </div>
      </div>
