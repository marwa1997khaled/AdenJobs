      ...
      <div class="course" style="margin-top: -50px;">
        <div class="preview">
          ...
          <?php
                ...
                if($result = mysqli_query($conn_link ,"SELECT Organization FROM jobs WHERE Id =4")){
        ...
        <div class="info">
          ...
          <a href="wfp1.php"><button class="btn">more information</button></a>
        </div>
      </div>
      ...
      <div class="course" style="margin-top: 150px;">
        <div class="preview">
          ...
          <?php
                if($conn_link= mysqli_connect('localhost' , 'root')){
                mysqli_select_db($conn_link ,'job');               
                if($result = mysqli_query($conn_link ,"SELECT Organization FROM jobs WHERE Id =5")){
                 while($rows=mysqli_fetch_assoc($result)){
                echo '' .$rows['Organization'];
                 }
                 }else{
        ...
        <div class="info">
          ...
          <a href="wfp2.php"><button class="btn">more information</button></a>
        </div>
      </div>
      ...
      <div class="course" style="margin-top: 350px;">
        <div class="preview">
          ...
          <?php
                if($conn_link= mysqli_connect('localhost' , 'root')){
                mysqli_select_db($conn_link ,'job');               
                if($result = mysqli_query($conn_link ,"SELECT Organization FROM jobs WHERE Id =6")){
                 while($rows=mysqli_fetch_assoc($result)){
                echo '' .$rows['Organization'];
                 }
                 }else{
        ...
        <div class="info">
          ...
          <a href="wfp3.php"><button class="btn">more information</button></a>
        </div>
      </div>
